...
INSERT INTO `oxconfig` VALUES ('a193fbb7085f21150.58370641', 'oxbaseshop', 'iShopID_TrustedShops', 'str', 0x53203d);
...
INSERT INTO `oxcontents` VALUES ('1544167b4666ccdc1.28484600', 'oxblocked', 'oxbaseshop', '1', '0', '1', '1', '', 'Benutzer geblockt', '<div><span style="color: #ff0000;"><strong>\r\n<img title="" height="200" alt="" src="out/oxbaseshop/pictures/wysiwigpro/stopsign.jpg" width="200"></strong></span></div>\r\n<div><span style="color: #ff0000;"><strong>Der Zugang wurde Ihnen verweigert !</strong></span></div>\r\n<div>&nbsp;</div>\r\n<div>&nbsp;</div>', 'user blocked', '<div><strong>Notice for Shop Administrator:</strong></div>\r\n<div><strong>&nbsp;</strong></div>\r\n<div>Update this text easily and comfortable in the Admin with a WYSYWYG-Editor.<strong>&nbsp;</strong></div>\r\n<div>&nbsp;</div>\r\n<div>Admin Menu: Customer Info -> CMS Pages -> user blocked</div>\r\n<div>&nbsp;</div>', '1', '', '', '1', '', '', '', 'CMSFOLDER_USERINFO');
INSERT INTO `oxcontents` VALUES ('c4241316c6e7b9503.93160420', 'oxbargain', 'oxbaseshop', '1', '0', '1', '1', '', 'Schnäppchen', '<table>[{foreach from=$articlebargainlist item=articlebargain_item}] <tbody><tr><td>\r\n<div class="product_image_s_container"><a href="[{$articlebargain_item->oxdetaillink}]"><img border="0" alt="[{ $articlebargain_item->oxarticles__oxtitle->value }][{if $articlebargain_item->oxarticles__oxvarselect->value }] [{ $articlebargain_item->oxarticles__oxvarselect->value }][{/if}] [{$oxcmp_shop->oxshops__oxtitlesuffix->value}]" src="[{ $articlebargain_item->dimagedir}]/[{$articlebargain_item->oxarticles__oxicon->value}]"></a></div> </td><td class="boxrightproduct-td"> <a href="[{$articlebargain_item->oxdetaillink}]" class="boxrightproduct-td"><strong>[{\r\n$articlebargain_item->oxarticles__oxtitle->value|cat:"\r\n"|cat:$articlebargain_item->oxarticles__oxvarselect->value|strip_tags|smartwordwrap:15:"<br>\r\n":2:1:"..."\r\n}]</strong></a><br>\r\n [{ if !$articlebargain_item->blNotBuyable  && !$articlebargain_item->blNotBuyableParent}] <a href="[{$articlebargain_item->tobasketlink}]&am=1" class="details" onclick="showBasketWnd();" rel="nofollow"><img border="0" src="[{$shop->imagedir}]/arrow_details.gif" alt=""> Jetzt bestellen! </a> [{/if}] </td></tr>[{/foreach}]\r\n</tbody></table>', 'Bargain', '<table>[{foreach from=$articlebargainlist item=articlebargain_item}] <tbody><tr><td>\r\n<div class="product_image_s_container"><a href="[{$articlebargain_item->oxdetaillink}]"><img border="0" src="[{ $articlebargain_item->dimagedir}]/[{$articlebargain_item->oxarticles__oxicon->value}]" alt="[{ $articlebargain_item->oxarticles__oxtitle->value }][{if $articlebargain_item->oxarticles__oxvarselect->value }] [{ $articlebargain_item->oxarticles__oxvarselect->value }][{/if}] [{$oxcmp_shop->oxshops__oxtitlesuffix->value}]"></a></div> </td><td class="boxrightproduct-td"> <a class="boxrightproduct-td" href="[{$articlebargain_item->oxdetaillink}]"><strong>[{\r\n$articlebargain_item->oxarticles__oxtitle->value|cat:"\r\n"|cat:$articlebargain_item->oxarticles__oxvarselect->value|strip_tags|smartwordwrap:15:"<br>\r\n ":2:1:"..."\r\n}]</strong></a><br>\r\n [{ if !$articlebargain_item->blNotBuyable  && !$articlebargain_item->blNotBuyableParent}] <a onclick="showBasketWnd();" class="details" href="[{$articlebargain_item->tobasketlink}]&am=1" rel="nofollow"><img border="0" alt="" src="[{$shop->imagedir}]/arrow_details.gif"> Order now! </a> [{/if}] </td></tr>[{/foreach}] </tbody></table>', '1', '', '', '1', '', '', 'oxrootid', 'CMSFOLDER_PRODUCTINFO');
...
INSERT INTO `oxcontents` VALUES ('f41427a07519469f1.34718981', 'oxdeliveryinfo', 'oxbaseshop', '1', '0', '1', '1', '', 'Versand', '<p>Fügen Sie hier Ihre Versandinformationen- und kosten ein.</p>', 'shipping', '<p>Add your shipping information and costs here.</p>', '1', '', '', '1', '', '', '8a142c3e4143562a5.46426637', 'CMSFOLDER_USERINFO');
INSERT INTO `oxcontents` VALUES ('f41427a099a603773.44301043', 'oxsecurityinfo', 'oxbaseshop', '1', '0', '1', '1', '', 'Sicherheitsinformationen', 'Fügen Sie hier Ihre Datenschutzbestimmungen ein.', 'security information', '<div>\r\n<div><strong>Notice for Shop Administrator:</strong></div>\r\n<div><strong>&nbsp;</strong></div>\r\n<div>Update this text easily and comfortable in the Admin with a WYSYWYG-Editor.<strong>&nbsp;</strong></div>\r\n<div>&nbsp;</div>\r\n<div>Admin Menu: Customer Info -> CMS Pages -> security information</div></div>', '1', '', '', '1', '', '', '8a142c3e4143562a5.46426637', 'CMSFOLDER_USERINFO');
...
INSERT INTO `oxcontents` VALUES ('ad542e49541c1add9.70119314', 'oxpassinfoemail', 'oxbaseshop', '1', '0', '1', '1', '', 'Ihr Passwort im eShop', 'Hallo [{ $user->oxuser__oxsal->value }] [{\r\n$user->oxuser__oxfname->value }] [{\r\n$user->oxuser__oxlname->value }],<br>\r\n<br>\r\nauf Ihren Wunsch hier die Zugangsdaten zum [{ $shop->oxshops__oxname->value }]:<br>\r\n<br>\r\nIhr Passwort lautet : [{ $user->oxuser__oxpassword->value }].<br>\r\n<br>\r\nIhr [{ $shop->oxshops__oxname->value }] Team<br>', 'password info', '<div>\r\n<div><strong>Notice for Shop Administrator:</strong></div>\r\n<div><strong>&nbsp;</strong></div>\r\n<div>Update this text easily and comfortable in the Admin with a WYSYWYG-Editor.<strong>&nbsp;</strong></div>\r\n<div>&nbsp;</div>\r\n<div>Admin Menu: Customer Info -> CMS Pages -> password info</div></div>', '1', '', '', '1', '', '', '8a142c3e4143562a5.46426637', 'CMSFOLDER_EMAILS');
INSERT INTO `oxcontents` VALUES ('ad542e495c392c6e5.90671640', 'oxpassinfoplainemail', 'oxbaseshop', '1', '0', '1', '1', '', 'Ihr Passwort im eShop Plain', 'Hallo [{ $user->oxuser__oxsal->value }] [{\r\n$user->oxuser__oxfname->value }] [{\r\n$user->oxuser__oxlname->value }],\r\n\r\nauf Ihren Wunsch hier die Zugangsdaten zum [{\r\n$shop->oxshops__oxname->value }]:\r\n\r\nIhr Passwort lautet: [{ $user->oxuser__oxpassword->value }].\r\n\r\nIhr [{ $shop->oxshops__oxname->value }] Team', 'password info plain', 'Notice for Shop Administrator:\r\n \r\nUpdate this text easily and comfortable in the Admin with a WYSYWYG-Editor. \r\n \r\nAdmin Menu: Customer Info -> CMS Pages -> password info plain\r\n', '1', '', '', '1', '', '', '8a142c3e4143562a5.46426637', 'CMSFOLDER_EMAILS');
...
INSERT INTO `oxcontents` VALUES ('1ea45574543b21636.29288751', 'oxrightofwithdrawal', 'oxbaseshop', '1', '0', '1', '1', '', 'Widerrufsrecht', 'Fügen Sie hier Ihre Widerrufsbelehrung ein.', 'Rights of Withdrawal', '<div>English version of rights of withdrawal&nbsp;</div>', '0', '', '', '0', '', '', '8a142c3e4143562a5.46426637', 'CMSFOLDER_USERINFO');
...
INSERT INTO `oxuser` VALUES ('oxdefaultadmin', '1', 'malladmin', 'oxbaseshop', 'admin', 'ox_BBpaRCslUU8u', 1, '', 'Ihr Firmenname', 'Hans', 'Mustermann', 'Musterstr.', '10', '', 'Musterstadt', 'a7c40f631fc920687.20179984', '79098', '0800 1234567', '0800 1234567', 'Herr', 1000, '2003-01-01 00:00:00', '2003-01-01 00:00:00', '', '', '0000-00-00', '', '0');
