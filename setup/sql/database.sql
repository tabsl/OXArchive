...
#
INSERT INTO `oxactions` VALUES ('oxstart', 'oxbaseshop', '0', 'Startseite unten', 'Start page bottom', '', '', '', '', '', '',  '0', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '', '', '', '', '', '', '', 0);
...
INSERT INTO `oxactions` VALUES ('oxfirststart', 'oxbaseshop', '0', 'Großes Angebot Startseite', 'Big offer start page', '', '', '', '', '', '', '1', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '', '', '', '', '', '', '', 0);
INSERT INTO `oxactions` VALUES ('oxbargain', 'oxbaseshop', '0', 'Schnäppchen', 'Bargain', '', '', '', '', '', '', '1', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '', '', '', '', '', '', '', 0);
...
INSERT INTO `oxconfigdisplay` VALUES('1ec42a395d0595ee7741091898848474', 'theme:azure', 'iNewBasketItemMessage',  'display',  '0|1|2', 19);
...
# Table structure for table `oxcontents`
#
INSERT INTO `oxcontents` VALUES('8709e45f31a86909e9f999222e80b1d0', 'oxstdfooter', 'oxbaseshop', 1, 0, 1, 1, '', 'Standard Footer', '<div>OXID Online Shop - Alles rund um das Thema Wassersport, Sportbekleidung und Mode </div>', 'standard footer', '<div>OXID Online Shop - All about watersports, sportswear and fashion </div>', 1, '', '', 1, '', '', '30e44ab83fdee7564.23264141', '', '');
...
INSERT INTO `oxcontents` VALUES('42e4667ffcf844be0.22563656', 'oxemailfooter', 'oxbaseshop', 1, 0, 1, 1, '', 'E-Mail Fußtext', '<p align="left">--</p>\r\n<p>Bitte fügen Sie hier Ihre vollständige Anbieterkennzeichnung ein.</p>', 'E-mail footer', '<p align="left">--</p>\r\n<p>Please insert your imprint here</p>', 0, '', '', 0, '', '', '8a142c3e4143562a5.46426637', 'CMSFOLDER_EMAILS', '');
INSERT INTO `oxcontents` VALUES('3194668fde854d711.73798992', 'oxemailfooterplain', 'oxbaseshop', 1, 0, 1, 1, '', 'E-Mail Fußtext Plain', '-- Bitte fügen Sie hier Ihre vollständige Anbieterkennzeichnung ein.', 'E-mail footer plain', '-- Please insert your imprint here.', 0, '', '', 0, '', '', '8a142c3e4143562a5.46426637', 'CMSFOLDER_EMAILS', '');
INSERT INTO `oxcontents` VALUES('e7a4518ce1e2c36a9.60268505', 'oxfirststart', 'oxbaseshop', 1, 0, 1, 1, '', 'UNSER SCHNÄPPCHEN!', '<div> Gültig solange Vorrat reicht. </div>', 'Our Bargain!', '<div>As long as on stock </div>', 1, '', '', 1, '', '', '8a142c3e4143562a5.46426637', 'CMSFOLDER_PRODUCTINFO', '');
INSERT INTO `oxcontents` VALUES('29142e76dd32dd477.41262508', 'oxforgotpwd', 'oxbaseshop', 1, 0, 1, 1, '', 'Passwort vergessen', 'Sollten Sie innerhalb der nächsten Minuten KEINE E-Mail mit Ihren Zugangsdaten erhalten, so überprüfen Sie bitte: Haben Sie sich in unserem Shop bereits registriert? Wenn nicht, so tun Sie dies bitte einmalig im Rahmen des Bestellprozesses. Sie können dann selbst ein Passwort festlegen. Sobald Sie registriert sind, können Sie sich in Zukunft mit Ihrer E-Mail-Adresse und Ihrem Passwort einloggen.\r\n<ul>\r\n<li class="font11">Wenn Sie sich sicher sind, dass Sie sich in unserem Shop bereits registriert haben, dann überprüfen Sie bitte, ob Sie sich bei der Eingabe Ihrer E-Mail-Adresse evtl. vertippt haben.</li></ul>\r\n<p>Sollten Sie trotz korrekter E-Mail-Adresse und bereits bestehender Registrierung weiterhin Probleme mit dem Login haben und auch keine "Passwort vergessen"-E-Mail erhalten, so wenden Sie sich bitte per E-Mail an: <a href="mailto:demo@oxid-esales.com?subject=Passwort"><strong>demo@oxid-esales.com</strong></a></p>', 'Forgot password', '<p>If you don''t get an e-mail with your access data, please make sure that you have already registered with us. As soon as you are registered, you can login with your e-mail address and your password.</p>\r\n<ul>\r\n<li>\r\nIf you are sure you are already registered, please check the e-mail address you entered as user name.</li></ul>\r\n<p>\r\nIn case you still have problems logging in, please turn to us by e-mail: <a href="mailto:demo@oxid-esales.com?subject=Password"><strong>demo@oxid-esales.com</strong></a></p>', 1, '', '', 1, '', '', '30e44ab83fdee7564.23264141', 'CMSFOLDER_EMAILS', '');
...
INSERT INTO `oxcontents` VALUES('84a42e66105998a86.14045828', 'oxuserorderemailend', 'oxbaseshop', 1, 0, 1, 1, '', 'Ihre Bestellung Abschluss', '<div align="left">Fügen Sie hier Ihre Widerrufsbelehrung ein.</div>', 'your order terms', '<p>Right to cancel can be inserted here.</p>', 1, '', '', 1, '', '', '30e44ab83fdee7564.23264141', 'CMSFOLDER_EMAILS', '');
INSERT INTO `oxcontents` VALUES('84a42e66123887821.29772527', 'oxuserorderemailendplain', 'oxbaseshop', 1, 0, 1, 1, '', 'Ihre Bestellung Abschluss Plain', 'Fügen Sie hier Ihre Widerrufsbelehrung ein.', 'your order terms plain', '<p>Right to cancel can be inserted here.</p>', 1, '', '', 1, '', '', '30e44ab83fdee7564.23264141', 'CMSFOLDER_EMAILS', '');
...
INSERT INTO `oxcountry` VALUES ('2db455824e4a19cc7.14731328', 0, 'Anderes Land', '', '', '', 10000, '', 'Select this if you can not find your country.', 'Other country', '', '', '', '', '', 'Select this if you can not find your country.', '', '', 0);
...
INSERT INTO `oxcountry` VALUES ('a7c40f632a0804ab5.18804076', 1, 'Vereinigtes Königreich', 'GB', 'GBR', '826', 9999, 'EU2', '', 'United Kingdom', '', '', 'EU2', '', '', '', '', '', 1);
...
INSERT INTO `oxcountry` VALUES ('8f241f1109547ae49.60154431', 0, 'Bangladesch', 'BD', 'BGD', '50', 9999, 'Rest Welt', '', 'Bangladesh', '', '', 'Rest World', '', '', '', '', '', 0);
INSERT INTO `oxcountry` VALUES ('8f241f11095497083.21181725', 0, 'Barbados', 'BB', 'BRB', '52', 9999, 'Rest Welt', '', 'Barbados', '', '', 'Rest World', '', '', '', '', '', 0);
INSERT INTO `oxcountry` VALUES ('8f241f110954ac5b9.63105203', 0, 'Weißrussland', 'BY', 'BLR', '112', 9999, 'Rest Europa', '', 'Belarus', '', '', 'Rest Europe', '', '', '', '', '', 0);
...
INSERT INTO `oxcountry` VALUES ('8f241f1109553f902.06960438', 0, 'Bosnien und Herzegowina', 'BA', 'BIH', '70', 9999, 'Rest Europa', '', 'Bosnia and Herzegovina', '', '', 'Rest Europe', '', '', '', '', '', 0);
INSERT INTO `oxcountry` VALUES ('8f241f11095554834.54199483', 0, 'Botsuana', 'BW', 'BWA', '72', 9999, 'Rest Welt', '', 'Botswana', '', '', 'Rest World', '', '', '', '', '', 0);
INSERT INTO `oxcountry` VALUES ('8f241f1109556dd57.84292282', 0, 'Bouvetinsel', 'BV', 'BVT', '74', 9999, 'Rest Welt', '', 'Bouvet Island', '', '', 'Rest World', '', '', '', '', '', 0);
INSERT INTO `oxcountry` VALUES ('8f241f11095592407.89986143', 0, 'Brasilien', 'BR', 'BRA', '76', 9999, 'Rest Welt', '', 'Brazil', '', '', 'Rest World', '', '', '', '', '', 0);
INSERT INTO `oxcountry` VALUES ('8f241f110955a7644.68859180', 0, 'Britisches Territorium im Indischen Ozean', 'IO', 'IOT', '86', 9999, 'Rest Welt', '', 'British Indian Ocean Territory', '', '', 'Rest World', '', '', '', '', '', 0);
INSERT INTO `oxcountry` VALUES ('8f241f110955bde61.63256042', 0, 'Brunei Darussalam', 'BN', 'BRN', '96', 9999, 'Rest Welt', '', 'Brunei Darussalam', '', '', 'Rest World', '', '', '', '', '', 0);
...
INSERT INTO `oxcountry` VALUES ('8f241f11095673248.50405852', 0, 'Kaimaninseln', 'KY', 'CYM', '136', 9999, 'Rest Welt', '', 'Cayman Islands', '', '', 'Rest World', '', '', '', '', '', 0);
...
INSERT INTO `oxcountry` VALUES ('8f241f110956df6b2.52283428', 0, 'Weihnachtsinsel', 'CX', 'CXR', '162', 9999, 'Rest Welt', '', 'Christmas Island', '', '', 'Rest World', '', '', '', '', '', 0);
INSERT INTO `oxcountry` VALUES ('8f241f110956f54b4.26327849', 0, 'Kokosinseln (Keelinginseln)', 'CC', 'CCK', '166', 9999, 'Rest Welt', '', 'Cocos (Keeling) Islands', '', '', 'Rest World', '', '', '', '', '', 0);
...
INSERT INTO `oxcountry` VALUES ('8f241f11095732184.72771986', 0, 'Kongo', 'CG', 'COG', '178', 9999, 'Rest Welt', '', 'Congo', '', '', 'Rest World', '', '', '', '', '', 0);
INSERT INTO `oxcountry` VALUES ('8f241f11095746a92.94878441', 0, 'Cookinseln', 'CK', 'COK', '184', 9999, 'Rest Welt', '', 'Cook Islands', '', '', 'Rest World', '', '', '', '', '', 0);
INSERT INTO `oxcountry` VALUES ('8f241f1109575d708.20084150', 0, 'Costa Rica', 'CR', 'CRI', '188', 9999, 'Rest Welt', '', 'Costa Rica', '', '', 'Rest World', '', '', '', '', '', 0);
INSERT INTO `oxcountry` VALUES ('8f241f11095771f76.87904122', 0, 'Cote d´Ivoire', 'CI', 'CIV', '384', 9999, 'Rest Welt', '', 'Cote d''Ivoire', '', '', 'Rest World', '', '', '', '', '', 0);
...
INSERT INTO `oxcountry` VALUES ('8f241f110957cb457.97820918', 0, 'Tschechische Republik', 'CZ', 'CZE', '203', 9999, 'Europa', '', 'Czech Republic', '', '', 'Europe', '', '', '', '', '', 1);
...
INSERT INTO `oxcountry` VALUES ('8f241f11095839323.86755169', 0, 'Timor-Leste', 'TL', 'TLS', '626', 9999, 'Rest Welt', '', 'Timor-Leste', '', '', 'Rest World', '', '', '', '', '', 0);
...
INSERT INTO `oxcountry` VALUES ('8f241f110958e2cc3.90770249', 0, 'Falklandinseln (Malwinen)', 'FK', 'FLK', '238', 9999, 'Rest Welt', '', 'Falkland Islands (Malvinas)', '', '', 'Rest World', '', '', '', '', '', 0);
...
INSERT INTO `oxcountry` VALUES ('8f241f1109594fcb1.79441780', 0, 'Französisch Guiana', 'GF', 'GUF', '254', 9999, 'Rest Welt', '', 'French Guiana', '', '', 'Rest World', '', '', '', '', '', 0);
...
INSERT INTO `oxcountry` VALUES ('8f241f110959784a3.34264829', 0, 'Französische Südgebiete', 'TF', 'ATF', '260', 9999, 'Rest Welt', '', 'French Southern Territories', '', '', 'Rest World', '', '', '', '', '', 0);
...
INSERT INTO `oxcountry` VALUES ('8f241f11095a9bf82.19989557', 0, 'Guinea', 'GN', 'GIN', '324', 9999, 'Rest Welt', '', 'Guinea', '', '', 'Rest World', '', '', '', '', '', 0);
...
INSERT INTO `oxcountry` VALUES ('8f241f11095aff2c3.98054755', 0, 'Heard Insel und McDonald Inseln', 'HM', 'HMD', '334', 9999, 'Rest Welt', '', 'Heard Island And Mcdonald Islands', '', '', 'Rest World', '', '', '', '', '', 0);
...
INSERT INTO `oxcountry` VALUES ('8f241f11095cc7ef5.28043767', 0, 'Kirgisistan', 'KG', 'KGZ', '417', 9999, 'Rest Welt', '', 'Kyrgyzstan', '', '', 'Rest World', '', '', '', '', '', 0);
INSERT INTO `oxcountry` VALUES ('8f241f11095cdccd5.96388808', 0, 'Laos', 'LA', 'LAO', '418', 9999, 'Rest Welt', '', 'Laos', '', '', 'Rest World', '', '', '', '', '', 0);
INSERT INTO `oxcountry` VALUES ('8f241f11095cf2ea6.73925511', 0, 'Lettland', 'LV', 'LVA', '428', 9999, 'Rest Europa', '', 'Latvia', '', '', 'Rest Europe', '', '', '', '', '', 1);
INSERT INTO `oxcountry` VALUES ('8f241f11095d07d87.58986129', 0, 'Libanon', 'LB', 'LBN', '422', 9999, 'Welt', '', 'Lebanon', '', '', 'World', '', '', '', '', '', 0);
...
INSERT INTO `oxcountry` VALUES ('8f241f11095d46188.64679605', 0, 'Libyen', 'LY', 'LBY', '434', 9999, 'Rest Welt', '', 'Libya', '', '', 'Rest World', '', '', '', '', '', 0);
INSERT INTO `oxcountry` VALUES ('8f241f11095d6ffa8.86593236', 0, 'Litauen', 'LT', 'LTU', '440', 9999, 'Rest Europa', '', 'Lithuania', '', '', 'Rest Europe', '', '', '', '', '', 1);
INSERT INTO `oxcountry` VALUES ('8f241f11095d9c1b2.13577033', 0, 'Macao', 'MO', 'MAC', '446', 9999, 'Rest Welt', '', 'Macao', '', '', 'Rest World', '', '', '', '', '', 0);
...
INSERT INTO `oxcountry` VALUES ('8f241f11095e0c6c9.43746477', 0, 'Malediven', 'MV', 'MDV', '462', 9999, 'Rest Welt', '', 'Maldives', '', '', 'Rest World', '', '', '', '', '', 0);
...
INSERT INTO `oxcountry` VALUES ('8f241f11095e4e338.26817244', 0, 'Marshallinseln', 'MH', 'MHL', '584', 9999, 'Rest Welt', '', 'Marshall Islands', '', '', 'Rest World', '', '', '', '', '', 0);
...
INSERT INTO `oxcountry` VALUES ('8f241f11095ed4902.49276197', 0, 'Mikronesien, Föderierte Staaten von', 'FM', 'FSM', '583', 9999, 'Rest Welt', '', 'Micronesia, Federated States Of', '', '', 'Rest World', '', '', '', '', '', 0);
INSERT INTO `oxcountry` VALUES ('8f241f11095ee9923.85175653', 0, 'Moldau', 'MD', 'MDA', '498', 9999, 'Rest Europa', '', 'Moldova', '', '', 'Rest Europe', '', '', '', '', '', 0);
...
INSERT INTO `oxcountry` VALUES ('8f241f110961442c2.82573898', 0, 'Norfolkinsel', 'NF', 'NFK', '574', 9999, 'Rest Welt', '', 'Norfolk Island', '', '', 'Rest World', '', '', '', '', '', 0);
INSERT INTO `oxcountry` VALUES ('8f241f11096162678.71164081', 0, 'Nördliche Marianen', 'MP', 'MNP', '580', 9999, 'Rest Welt', '', 'Northern Mariana Islands', '', '', 'Rest World', '', '', '', '', '', 0);
...
INSERT INTO `oxcountry` VALUES ('8f241f11096234d62.44125992', 0, 'Pitcairn', 'PN', 'PCN', '612', 9999, 'Rest Welt', '', 'Pitcairn', '', '', 'Rest World', '', '', '', '', '', 0);
...
INSERT INTO `oxcountry` VALUES ('8f241f110962a3ec5.65857240', 0, 'Réunion', 'RE', 'REU', '638', 9999, 'Rest Welt', '', 'Réunion', '', '', 'Rest World', '', '', '', '', '', 0);
INSERT INTO `oxcountry` VALUES ('8f241f110962c3007.60363573', 0, 'Rumänien', 'RO', 'ROU', '642', 9999, 'Rest Europa', '', 'Romania', '', '', 'Rest Europe', '', '', '', '', '', 1);
INSERT INTO `oxcountry` VALUES ('8f241f110962e40e6.75062153', 0, 'Russische Föderation', 'RU', 'RUS', '643', 9999, 'Rest Europa', '', 'Russian Federation', '', '', 'Rest Europe', '', '', '', '', '', 0);
INSERT INTO `oxcountry` VALUES ('8f241f110962f8615.93666560', 0, 'Ruanda', 'RW', 'RWA', '646', 9999, 'Rest Welt', '', 'Rwanda', '', '', 'Rest World', '', '', '', '', '', 0);
INSERT INTO `oxcountry` VALUES ('8f241f110963177a7.49289900', 0, 'St. Kitts und Nevis', 'KN', 'KNA', '659', 9999, 'Rest Welt', '', 'Saint Kitts and Nevis', '', '', 'Rest World', '', '', '', '', '', 0);
INSERT INTO `oxcountry` VALUES ('8f241f1109632fab4.68646740', 0, 'St. Lucia', 'LC', 'LCA', '662', 9999, 'Rest Welt', '', 'Saint Lucia', '', '', 'Rest World', '', '', '', '', '', 0);
INSERT INTO `oxcountry` VALUES ('8f241f110963443c3.29598809', 0, 'St. Vincent und die Grenadinen', 'VC', 'VCT', '670', 9999, 'Rest Welt', '', 'Saint Vincent and The Grenadines', '', '', 'Rest World', '', '', '', '', '', 0);
...
INSERT INTO `oxcountry` VALUES ('8f241f110963f98d8.68428379', 0, 'Serbien', 'RS', 'SRB', '688', 9999, 'Rest Europa', '', 'Serbia', '', '', 'Rest Europe', '', '', '', '', '', 0);
...
INSERT INTO `oxcountry` VALUES ('8f241f1109654dca4.99466434', 0, 'Saint Helena', 'SH', 'SHN', '654', 9999, 'Rest Welt', '', 'Saint Helena', '', '', 'Rest World', '', '', '', '', '', 0);
...
INSERT INTO `oxcountry` VALUES ('8f241f110965eb7b7.26149742', 0, 'Svalbard und Jan Mayen', 'SJ', 'SJM', '744', 9999, 'Rest Welt', '', 'Svalbard and Jan Mayen', '', '', 'Rest World', '', '', '', '', '', 0);
INSERT INTO `oxcountry` VALUES ('8f241f1109660c113.62780718', 0, 'Swasiland', 'SZ', 'SWZ', '748', 9999, 'Rest Welt', '', 'Swaziland', '', '', 'Rest World', '', '', '', '', '', 0);
INSERT INTO `oxcountry` VALUES ('8f241f1109666b7f3.81435898', 0, 'Syrien', 'SY', 'SYR', '760', 9999, 'Rest Welt', '', 'Syria', '', '', 'Rest World', '', '', '', '', '', 0);
INSERT INTO `oxcountry` VALUES ('8f241f11096687ec7.58824735', 0, 'Republik China (Taiwan)', 'TW', 'TWN', '158', 9999, 'Rest Welt', '', 'Taiwan, Province of China', '', '', 'Rest World', '', '', '', '', '', 0);
...
INSERT INTO `oxcountry` VALUES ('8f241f11096877ac0.98748826', 1, 'Vereinigte Staaten von Amerika', 'US', 'USA', '840', 9999, 'Welt', '', 'United States', '', '', 'World', '', '', '', '', '', 0);
INSERT INTO `oxcountry` VALUES ('8f241f11096894977.41239553', 0, 'United States Minor Outlying Islands', 'UM', 'UMI', '581', 9999, 'Rest Welt', '', 'United States Minor Outlying Islands', '', '', 'Rest World', '', '', '', '', '', 0);
...
INSERT INTO `oxcountry` VALUES ('8f241f110968ebc30.63792746', 0, 'Heiliger Stuhl (Vatikanstadt)', 'VA', 'VAT', '336', 9999, 'Europa', '', 'Holy See (Vatican City State)', '', '', 'Europe', '', '', '', '', '', 0);
...
INSERT INTO `oxcountry` VALUES ('8f241f1109692fc04.15216034', 0, 'Britische Jungferninseln', 'VG', 'VGB', '92', 9999, 'Rest Welt', '', 'Virgin Islands, British', '', '', 'Rest World', '', '', '', '', '', 0);
INSERT INTO `oxcountry` VALUES ('8f241f11096944468.61956573', 0, 'Amerikanische Jungferninseln', 'VI', 'VIR', '850', 9999, 'Rest Welt', '', 'Virgin Islands, U.S.', '', '', 'Rest World', '', '', '', '', '', 0);
INSERT INTO `oxcountry` VALUES ('8f241f110969598c8.76966113', 0, 'Wallis und Futuna', 'WF', 'WLF', '876', 9999, 'Rest Welt', '', 'Wallis and Futuna', '', '', 'Rest World', '', '', '', '', '', 0);
INSERT INTO `oxcountry` VALUES ('8f241f1109696e4e9.33006292', 0, 'Westsahara', 'EH', 'ESH', '732', 9999, 'Rest Welt', '', 'Western Sahara', '', '', 'Rest World', '', '', '', '', '', 0);
INSERT INTO `oxcountry` VALUES ('8f241f11096982354.73448958', 0, 'Jemen', 'YE', 'YEM', '887', 9999, 'Rest Welt', '', 'Yemen', '', '', 'Rest World', '', '', '', '', '', 0);
INSERT INTO `oxcountry` VALUES ('a7c40f632a0804ab5.18804099', 0, 'Åland Inseln', 'AX', 'ALA', '248', 9999, 'Rest Welt', '', 'Åland Islands', '', '', 'Rest World', '', '', '', '', '', 0);
...
INSERT INTO `oxcountry` VALUES ('56d308a822c18e106.3ba59048', 0, 'Montenegro', 'ME', 'MNE', '499', 9999, 'Rest Europa', '', 'Montenegro', '', '', 'Rest Europe', '', '', '', '', '', 0);
INSERT INTO `oxcountry` VALUES ('8f241f1109575d708.20084199', 0, 'Kongo, Dem. Rep.', 'CD', 'COD', '180', 9999, 'Rest Welt', '', 'Congo, The Democratic Republic Of The', '', '', 'Rest World', '', '', '', '', '', 0);
INSERT INTO `oxcountry` VALUES ('56d308a822c18e106.3ba59099', 0, 'Guernsey', 'GG', 'GGY', '831', 9999, 'Rest Welt', '', 'Guernsey', '', '', 'Rest World', '', '', '', '', '', 0);
INSERT INTO `oxcountry` VALUES ('8f241f11096982354.73448999', 0, 'Isle of Man', 'IM', 'IMN', '833', 9999, 'Rest Welt', '', 'Isle Of Man', '', '', 'Rest World', '', '', '', '', '', 0);
INSERT INTO `oxcountry` VALUES ('8f241f11096944468.61956599', 0, 'Jersey', 'JE', 'JEY', '832', 9999, 'Rest Welt', '', 'Jersey', '', '', 'Rest World', '', '', '', '', '', 0);
INSERT INTO `oxcountry` VALUES ('8f241f110968ebc30.63792799', 0, 'Palästinische Gebiete', 'PS', 'PSE', '275', 9999, 'Rest Welt', '', 'Palestinian Territory, Occupied', '', '', 'Rest World', '', '', '', '', '', 0);
INSERT INTO `oxcountry` VALUES ('8f241f110968a7cc9.56710199', 0, 'Saint-Barthélemy', 'BL', 'BLM', '652', 9999, 'Rest Welt', '', 'Saint Barthélemy', '', '', 'Rest World', '', '', '', '', '', 0);
INSERT INTO `oxcountry` VALUES ('a7c40f632f65bd8e2.84963299', 0, 'Saint-Martin', 'MF', 'MAF', '663', 9999, 'Rest Welt', '', 'Saint Martin', '', '', 'Rest World', '', '', '', '', '', 0);
INSERT INTO `oxcountry` VALUES ('8f241f1109533b943.50287999', 0, 'Südgeorgien und die Südlichen Sandwichinseln', 'GS', 'SGS', '239', 9999, 'Rest Welt', '', 'South Georgia and The South Sandwich Islands', '', '', 'Rest World', '', '', '', '', '', 0);
...
INSERT INTO `oxgroups` VALUES ('oxidblacklist', 1, 'Blacklist', 'Blacklist', '', '');
INSERT INTO `oxgroups` VALUES ('oxidsmallcust', 1, 'Geringer Umsatz', 'Less Turnover', '', '');
INSERT INTO `oxgroups` VALUES ('oxidmiddlecust', 1, 'Mittlerer Umsatz', 'Medium Turnover', '', '');
INSERT INTO `oxgroups` VALUES ('oxidgoodcust', 1, 'Grosser Umsatz', 'Huge Turnover', '', '');
INSERT INTO `oxgroups` VALUES ('oxidforeigncustomer', 1, 'Auslandskunde', 'Foreign Customer', '', '');
INSERT INTO `oxgroups` VALUES ('oxidnewcustomer', 1, 'Inlandskunde', 'Domestic Customer', '', '');
INSERT INTO `oxgroups` VALUES ('oxidpowershopper', 1, 'Powershopper', 'Powershopper', '', '');
INSERT INTO `oxgroups` VALUES ('oxiddealer', 1, 'Händler', 'Retailer', '', '');
INSERT INTO `oxgroups` VALUES ('oxidnewsletter', 1, 'Newsletter-Abonnenten', 'Newsletter Recipients', '', '');
INSERT INTO `oxgroups` VALUES ('oxidadmin', 1, 'Shop-Admin', 'Store Administrator', '', '');
INSERT INTO `oxgroups` VALUES ('oxidpriceb', 1, 'Preis B', 'Price B', '', '');
INSERT INTO `oxgroups` VALUES ('oxidpricea', 1, 'Preis A', 'Price A', '', '');
INSERT INTO `oxgroups` VALUES ('oxidpricec', 1, 'Preis C', 'Price C', '', '');
...
INSERT INTO `oxpayments` VALUES ('oxidcashondel', 1, 'Nachnahme', 7.5, 'abs', 0, 0, 0, 1000000, '', 1, 'COD (Cash on Delivery)', '', '', '', '', '', '', '', '', '', 0, '');
...
INSERT INTO `oxpayments` VALUES ('oxiddebitnote', 1, 'Bankeinzug/Lastschrift', 0, 'abs', 0, 0, 0, 1000000, 'lsbankname__@@lsblz__@@lsktonr__@@lsktoinhaber__@@', 0, 'Direct Debit', 'lsbankname__@@lsblz__@@lsktonr__@@lsktoinhaber__@@', '', '', '', '', 'Die Belastung Ihres Kontos erfolgt mit dem Versand der Ware.', 'Your bank account will be charged when the order is shipped.', '', '', 0, '');
INSERT INTO `oxpayments` VALUES ('oxidpayadvance', 1, 'Vorauskasse', 0, 'abs', 0, 0, 0, 1000000, '', 1, 'Cash in advance', '', '', '', '', '', '', '', '', '', 0, '');
INSERT INTO `oxpayments` VALUES ('oxidinvoice', 1, 'Rechnung', 0, 'abs', 0, 800, 0, 1000000, '', 0, 'Invoice', '', '', '', '', '', '', '', '', '', 0, '');
INSERT INTO `oxpayments` VALUES ('oxempty', 1, 'Empty', 0, 'abs', 0, 0, 0, 0, '', 0, 'Empty', '', '', '', '', '', 'for other countries', 'An example. Maybe for use with other countries', '', '', 0, '');
...
('61c5d6965b480012aabb3a6701254b75', '347333f119c147545287d02ff8954b8e', 'oxbaseshop', 1, 'index.php?cl=recommlist', 0x656e2f5265636f6d656e646174696f6e2d4c697374732f, 'static', 0, 0, ''),
...
CREATE OR REPLACE VIEW oxv_oxartextends_de AS SELECT OXID,OXLONGDESC,OXTAGS FROM oxartextends;
CREATE OR REPLACE VIEW oxv_oxartextends_en AS SELECT OXID,OXLONGDESC_1 AS OXLONGDESC,OXTAGS_1 AS OXTAGS FROM oxartextends;

CREATE OR REPLACE VIEW oxv_oxattribute AS SELECT oxattribute.* FROM oxattribute;
CREATE OR REPLACE VIEW oxv_oxattribute_de AS SELECT OXID,OXSHOPID,OXTITLE,OXPOS FROM oxattribute;
CREATE OR REPLACE VIEW oxv_oxattribute_en AS SELECT OXID,OXSHOPID,OXTITLE_1 AS OXTITLE,OXPOS FROM oxattribute;
...
CREATE OR REPLACE VIEW oxv_oxcontents_en AS SELECT OXID,OXLOADID,OXSHOPID,OXSNIPPET,OXTYPE,OXACTIVE_1 AS OXACTIVE,OXPOSITION,OXTITLE_1 AS OXTITLE,OXCONTENT_1 AS OXCONTENT,OXCATID,OXFOLDER,OXTERMVERSION FROM oxcontents;

CREATE OR REPLACE VIEW oxv_oxcountry AS SELECT oxcountry.* FROM oxcountry;
CREATE OR REPLACE VIEW oxv_oxcountry_de AS SELECT OXID,OXACTIVE,OXTITLE,OXISOALPHA2,OXISOALPHA3,OXUNNUM3,OXORDER,OXSHORTDESC,OXLONGDESC,OXVATSTATUS FROM oxcountry;
CREATE OR REPLACE VIEW oxv_oxcountry_en AS SELECT OXID,OXACTIVE,OXTITLE_1 AS OXTITLE,OXISOALPHA2,OXISOALPHA3,OXUNNUM3,OXORDER,OXSHORTDESC_1 AS OXSHORTDESC,OXLONGDESC_1 AS OXLONGDESC,OXVATSTATUS FROM oxcountry;

CREATE OR REPLACE VIEW oxv_oxdelivery AS SELECT oxdelivery.* FROM oxdelivery;
CREATE OR REPLACE VIEW oxv_oxdelivery_de AS SELECT OXID,OXSHOPID,OXACTIVE,OXACTIVEFROM,OXACTIVETO,OXTITLE,OXADDSUMTYPE,OXADDSUM,OXDELTYPE,OXPARAM,OXPARAMEND,OXFIXED,OXSORT,OXFINALIZE FROM oxdelivery;
CREATE OR REPLACE VIEW oxv_oxdelivery_en AS SELECT OXID,OXSHOPID,OXACTIVE,OXACTIVEFROM,OXACTIVETO,OXTITLE_1 AS OXTITLE,OXADDSUMTYPE,OXADDSUM,OXDELTYPE,OXPARAM,OXPARAMEND,OXFIXED,OXSORT,OXFINALIZE FROM oxdelivery;

CREATE OR REPLACE VIEW oxv_oxdiscount AS SELECT oxdiscount.* FROM oxdiscount;
CREATE OR REPLACE VIEW oxv_oxdiscount_de AS SELECT OXID,OXSHOPID,OXACTIVE,OXACTIVEFROM,OXACTIVETO,OXTITLE,OXAMOUNT,OXAMOUNTTO,OXPRICETO,OXPRICE,OXADDSUMTYPE,OXADDSUM,OXITMARTID,OXITMAMOUNT,OXITMMULTIPLE FROM oxdiscount;
CREATE OR REPLACE VIEW oxv_oxdiscount_en AS SELECT OXID,OXSHOPID,OXACTIVE,OXACTIVEFROM,OXACTIVETO,OXTITLE_1 AS OXTITLE,OXAMOUNT,OXAMOUNTTO,OXPRICETO,OXPRICE,OXADDSUMTYPE,OXADDSUM,OXITMARTID,OXITMAMOUNT,OXITMMULTIPLE FROM oxdiscount;

CREATE OR REPLACE VIEW oxv_oxgroups AS SELECT oxgroups.* FROM oxgroups;
CREATE OR REPLACE VIEW oxv_oxgroups_de AS SELECT OXID,OXACTIVE,OXTITLE FROM oxgroups;
CREATE OR REPLACE VIEW oxv_oxgroups_en AS SELECT OXID,OXACTIVE,OXTITLE_1 AS OXTITLE FROM oxgroups;

CREATE OR REPLACE VIEW oxv_oxlinks AS SELECT oxlinks.* FROM oxlinks;
CREATE OR REPLACE VIEW oxv_oxlinks_de AS SELECT OXID,OXSHOPID,OXACTIVE,OXURL,OXURLDESC,OXINSERT FROM oxlinks;
CREATE OR REPLACE VIEW oxv_oxlinks_en AS SELECT OXID,OXSHOPID,OXACTIVE,OXURL,OXURLDESC_1 AS OXURLDESC,OXINSERT FROM oxlinks;

CREATE OR REPLACE VIEW oxv_oxnews AS SELECT oxnews.* FROM oxnews;
CREATE OR REPLACE VIEW oxv_oxnews_de AS SELECT OXID,OXSHOPID,OXACTIVE,OXACTIVEFROM,OXACTIVETO,OXDATE,OXSHORTDESC,OXLONGDESC FROM oxnews;
CREATE OR REPLACE VIEW oxv_oxnews_en AS SELECT OXID,OXSHOPID,OXACTIVE_1 AS OXACTIVE,OXACTIVEFROM,OXACTIVETO,OXDATE,OXSHORTDESC_1 AS OXSHORTDESC,OXLONGDESC_1 AS OXLONGDESC FROM oxnews;

CREATE OR REPLACE VIEW oxv_oxobject2attribute AS SELECT oxobject2attribute.* FROM oxobject2attribute;
CREATE OR REPLACE VIEW oxv_oxobject2attribute_de AS SELECT OXID,OXOBJECTID,OXATTRID,OXVALUE,OXPOS FROM oxobject2attribute;
CREATE OR REPLACE VIEW oxv_oxobject2attribute_en AS SELECT OXID,OXOBJECTID,OXATTRID,OXVALUE_1 AS OXVALUE,OXPOS FROM oxobject2attribute;

CREATE OR REPLACE VIEW oxv_oxpayments AS SELECT oxpayments.* FROM oxpayments;
CREATE OR REPLACE VIEW oxv_oxpayments_de AS SELECT OXID,OXACTIVE,OXDESC,OXADDSUM,OXADDSUMTYPE,OXADDSUMRULES,OXFROMBONI,OXFROMAMOUNT,OXTOAMOUNT,OXVALDESC,OXCHECKED,OXLONGDESC,OXSORT,OXTSPAYMENTID FROM oxpayments;
CREATE OR REPLACE VIEW oxv_oxpayments_en AS SELECT OXID,OXACTIVE,OXDESC_1 AS OXDESC,OXADDSUM,OXADDSUMTYPE,OXADDSUMRULES,OXFROMBONI,OXFROMAMOUNT,OXTOAMOUNT,OXVALDESC_1 AS OXVALDESC,OXCHECKED,OXLONGDESC_1 AS OXLONGDESC,OXSORT,OXTSPAYMENTID FROM oxpayments;

CREATE OR REPLACE VIEW oxv_oxselectlist AS SELECT oxselectlist.* FROM oxselectlist;
CREATE OR REPLACE VIEW oxv_oxselectlist_de AS SELECT OXID,OXSHOPID,OXTITLE,OXIDENT,OXVALDESC FROM oxselectlist;
CREATE OR REPLACE VIEW oxv_oxselectlist_en AS SELECT OXID,OXSHOPID,OXTITLE_1 AS OXTITLE,OXIDENT,OXVALDESC_1 AS OXVALDESC FROM oxselectlist;
...
CREATE OR REPLACE VIEW oxv_oxactions_de AS SELECT OXID,OXSHOPID,OXTYPE,OXTITLE,OXLONGDESC,OXACTIVE,OXACTIVEFROM,OXACTIVETO,OXPIC,OXLINK,OXSORT FROM oxactions;
CREATE OR REPLACE VIEW oxv_oxactions_en AS SELECT OXID,OXSHOPID,OXTYPE,OXTITLE_1 AS OXTITLE,OXLONGDESC_1 AS OXLONGDESC,OXACTIVE,OXACTIVEFROM,OXACTIVETO,OXPIC_1 AS OXPIC,OXLINK_1 AS OXLINK,OXSORT FROM oxactions;

CREATE OR REPLACE VIEW oxv_oxwrapping AS SELECT oxwrapping.* FROM oxwrapping;
CREATE OR REPLACE VIEW oxv_oxwrapping_de AS SELECT OXID,OXSHOPID,OXACTIVE,OXTYPE,OXNAME,OXPIC,OXPRICE FROM oxwrapping;
CREATE OR REPLACE VIEW oxv_oxwrapping_en AS SELECT OXID,OXSHOPID,OXACTIVE_1 AS OXACTIVE,OXTYPE,OXNAME_1 AS OXNAME,OXPIC,OXPRICE FROM oxwrapping;

CREATE OR REPLACE VIEW oxv_oxdeliveryset AS SELECT oxdeliveryset.* FROM oxdeliveryset;
CREATE OR REPLACE VIEW oxv_oxdeliveryset_de AS SELECT OXID,OXSHOPID,OXACTIVE,OXACTIVEFROM,OXACTIVETO,OXTITLE,OXPOS FROM oxdeliveryset;
CREATE OR REPLACE VIEW oxv_oxdeliveryset_en AS SELECT OXID,OXSHOPID,OXACTIVE,OXACTIVEFROM,OXACTIVETO,OXTITLE_1 AS OXTITLE,OXPOS FROM oxdeliveryset;

CREATE OR REPLACE VIEW oxv_oxvendor AS SELECT oxvendor.* FROM oxvendor;
CREATE OR REPLACE VIEW oxv_oxvendor_de AS SELECT OXID,OXSHOPID,OXACTIVE,OXICON,OXTITLE,OXSHORTDESC,OXSHOWSUFFIX FROM oxvendor;
CREATE OR REPLACE VIEW oxv_oxvendor_en AS SELECT OXID,OXSHOPID,OXACTIVE,OXICON,OXTITLE_1 AS OXTITLE,OXSHORTDESC_1 AS OXSHORTDESC,OXSHOWSUFFIX FROM oxvendor;

CREATE OR REPLACE VIEW oxv_oxmanufacturers AS SELECT oxmanufacturers.* FROM oxmanufacturers;
CREATE OR REPLACE VIEW oxv_oxmanufacturers_de AS SELECT OXID,OXSHOPID,OXACTIVE,OXICON,OXTITLE,OXSHORTDESC,OXSHOWSUFFIX FROM oxmanufacturers;
CREATE OR REPLACE VIEW oxv_oxmanufacturers_en AS SELECT OXID,OXSHOPID,OXACTIVE,OXICON,OXTITLE_1 AS OXTITLE,OXSHORTDESC_1 AS OXSHORTDESC,OXSHOWSUFFIX FROM oxmanufacturers;

CREATE OR REPLACE VIEW oxv_oxmediaurls AS SELECT oxmediaurls.* FROM oxmediaurls;
CREATE OR REPLACE VIEW oxv_oxmediaurls_de AS SELECT OXID,OXOBJECTID,OXURL,OXDESC,OXISUPLOADED FROM oxmediaurls;
CREATE OR REPLACE VIEW oxv_oxmediaurls_en AS SELECT OXID,OXOBJECTID,OXURL,OXDESC_1 AS OXDESC,OXISUPLOADED FROM oxmediaurls;
