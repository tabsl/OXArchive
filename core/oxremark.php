 ...
 * $Id: oxremark.php 13617 2008-10-24 09:38:46Z sarunas $
 */
...
class oxRemark extends oxBase
{
    ...
    public function load( $oxID )
    {
        if ( $blRet = parent::load( $oxID ) ) {
            ...
            $this->oxremark__oxcreate = new oxField(oxUtilsDate::getInstance()->formatDBDate( $this->oxremark__oxcreate->value ), oxField::T_RAW);
        }
