 ...
 * $Id: delivery_main.inc.php 14035 2008-11-06 14:48:53Z arvydas $
 */
...
class ajaxComponent extends ajaxListComponent
{
    ...
    protected function _getQuery()
    {
        ...
        if ( !$sId) {
            ...
            $sQAdd .= " where oxobject2delivery.oxdeliveryid = '$sId' and oxobject2delivery.oxtype = 'oxcountry' ";
        }
        ...
        if ( $sSynchId && $sSynchId != $sId ) {
            ...
            $sQAdd .= " where oxobject2delivery.oxdeliveryid = '$sSynchId' and oxobject2delivery.oxtype = 'oxcountry' ) ";
        }
