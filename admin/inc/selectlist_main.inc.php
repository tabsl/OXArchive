 ...
 * $Id: selectlist_main.inc.php 14035 2008-11-06 14:48:53Z arvydas $
 */
    ...
    public function addarttosel()
    {
        ...
        if ( $soxId && $soxId != "-1" && is_array( $aAddArticle ) ) {
            foreach ($aAddArticle as $sAdd) {
                ...
                $oNewGroup->oxobject2selectlist__oxsort   = new oxField( ( int ) oxDb::getDb()->getOne( "select max(oxsort) + 1 from oxobject2selectlist where oxobjectid = '$sAdd' " ) );
                $oNewGroup->save();
            }
        }
    }
