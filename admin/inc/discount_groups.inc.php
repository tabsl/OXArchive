 ...
 * $Id: discount_groups.inc.php 14035 2008-11-06 14:48:53Z arvydas $
 */
...
class ajaxComponent extends ajaxListComponent
{
    ...
    protected function _getQuery()
    {
        ...
        if ( !$sId) {
            ...
            $sQAdd .= " and oxobject2discount.oxdiscountid = '$sId' and oxobject2discount.oxtype = 'oxgroups' ";
        }
        ...
        if ( $sSynchId && $sSynchId != $sId) {
            ...
            $sQAdd .= " and oxobject2discount.oxdiscountid = '$sSynchId' and oxobject2discount.oxtype = 'oxgroups' ) ";
        }
    ...
    public function removediscgroup()
    {
        ...
        if ( oxConfig::getParameter( 'all' ) ) {
            ...
            $sQ = "delete from oxobject2discount where oxobject2discount.oxid in ('" . implode( "', '", $aRemoveGroups ) . "') ";
            oxDb::getDb()->Execute( $sQ );
        }
    }
