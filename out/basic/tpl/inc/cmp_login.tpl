    ...
    <div>
        ...
        <table class="form">
          ...
          <tr>
            ...
            <td>
              <a id="test_LoginRegister" href="[{ oxgetseourl ident=$oViewConf->getSelfLink()|cat:"cl=register" }]" class="link" rel="nofollow">[{ oxmultilang ident="INC_CMP_LOGIN_OPENACCOUNT" }]</a><br />
