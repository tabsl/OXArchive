...
<tr>
    <td class="listheader first" height="15" colspan="2">&nbsp;<a href="Javascript:document.search.sort.value='oxdesc';document.search.submit();" class="listheader">[{ oxmultilang ident="GENERAL_DESCRIPTION" }]</a></td>
</tr>
