...
<colgroup><col width="49%"><col width="49%"><col width="2%"></colgroup>
<tr class="listitem">
...
<tr>
    ...
    <td class="listheader" height="15" colspan="2"><a href="Javascript:document.search.sort.value='oxident';document.search.submit();" class="listheader">[{ oxmultilang ident="GENERAL_TITLEIDENT" }]</a></td>
</tr>
...
[{foreach from=$mylist item=listitem}]
    ...
    [{ /if}]
    <td valign="top" class="[{ $listclass}]" height="15"><div class="listitemfloating">&nbsp;<a href="Javascript:EditThis('[{ $listitem->oxselectlist__oxid->value}]');" class="[{ $listclass}]">[{ $listitem->oxselectlist__oxtitle->value }]</a></div></td>
    <td valign="top" class="[{ $listclass}]" height="15"><div class="listitemfloating"><a href="Javascript:EditThis('[{ $listitem->oxselectlist__oxid->value}]');" class="[{ $listclass}]">[{ $listitem->oxselectlist__oxident->value }]</a></div></td>
    <td class="[{ $listclass}]">
      [{if !$readonly }]
          <a href="Javascript:DeleteThis('[{ $listitem->oxselectlist__oxid->value }]');" class="delete" id="del.[{$_cnt}]" [{include file="help.tpl" helpid=item_delete}]></a>
      [{/if}]
    </td>
</tr>
[{if $blWhite == "2"}]
