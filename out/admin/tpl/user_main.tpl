...
/*
    if( document.myedit.elements["editval[oxuser__oxpassword]"].value == "")
     {    alert("Bitte Passwort eingeben!");
           document.myedit.elements["editval[oxuser__oxpassword]"].focus();
           return false;
    }
*/
    return true;
...
<form name="myedit" id="myedit" action="[{ $shop->selflink }]" method="post" onSubmit="return chkInsert()">
[{ $shop->hiddensid }]
<input type="hidden" name="cl" value="user_main">
