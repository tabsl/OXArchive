...
<form name="myedit" id="myedit" action="[{ $shop->selflink }]" method="post" target="edit">
[{ $shop->hiddensid }]
<input type="hidden" name="cl" value="statistic_main">
    ...
    <td valign="top">
        ...
        <tr>
          <td class="edittext">
            ...
            <br>
            <input type="submit" class="edittext" id="_genreportsbtn" name="save" value="[{ oxmultilang ident="STASTISTIC_MAIN_GENERATE" }]" onClick="Javascript:document.myedit.target='_new';document.myedit.fnc.value='generate'" [{if !$ireports}]readonly disabled[{/if}]><br>
          </td>
        </tr>
        ...
        <tr>
            ...
            <input type="text" class="editinput" size="32" maxlength="[{$edit->oxstatistics__oxtitle->fldmax_length}]" name="editval[oxstatistics__oxtitle]" value="[{$edit->oxstatistics__oxtitle->value}]" [{ $readonly }]><br>
