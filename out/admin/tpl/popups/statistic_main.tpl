...
<script type="text/javascript">
    initAoc = function()
    {
        YAHOO.oxid.container1 = new YAHOO.oxid.aoc( 'container1',
                                                    [ [{ foreach from=$oxajax.container1 item=aItem key=iKey }]
                                                      ...
                                                      [{ /foreach }] ],
                                                    '[{ $oViewConf->getAjaxLink() }]cmpid=container1&container=statistic_main&synchoxid=[{ $oxid }]'
                                                    );
        ...
        YAHOO.oxid.container2 = new YAHOO.oxid.aoc( 'container2',
                                                    [ [{ foreach from=$oxajax.container2 item=aItem key=iKey }]
                                                      ...
                                                      [{assign var="sSep" value=","}]
                                                      [{ /foreach }] ],
                                                    '[{ $oViewConf->getAjaxLink() }]cmpid=container2&container=statistic_main&oxid=[{ $oxid }]'
                                                    );
    ...
    <table width="100%">
        ...
        <tr class="edittext">
            <td align="center"><b>[{ oxmultilang ident="STASTISTIC_MAIN_REPORTS" }]</b></td>
            <td align="center"><b>[{ oxmultilang ident="STASTISTIC_MAIN_SELREPORTS" }]</b></td>
        </tr>
        <tr>
